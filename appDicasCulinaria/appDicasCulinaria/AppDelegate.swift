    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        if userDefaults.object(forKey: "Tips") == nil {
            ...
            dict = [
                ...
                "2" : Tip(title: "Posição das panelas no fogão", text: "Ao utilizar panelas no fogão, procure deixar os cabos apontados para fora, evitando que aqueçam muito, enquanto as panelas estão no fogo.", tag: [2, 3, 4], fav: false, imgURL: ""),
                ...
                "7" : Tip(title: "Reaquecimento de pães", text: "Para manter a crocância de pães amanhecidos (pães do dia anterior), umedeça a superfície do pão com água e, em seguida, aqueça o pão no forno baixo (180 graus), por cerca de cinco a dez minutos, a depender da quantidade de pães.", tag: [2, 3, 4, 9], fav: false, imgURL: ""),
                "8" : Tip(title: "Quantidade da massa de bolo na forma", text: "Ao fazer um bolo, não preencha mais da metade da forma com a massa do bolo para evitar que a massa transborde dentro do forno por causa do seu crescimento quando do cozimento.", tag: [2, 4], fav: false, imgURL: ""),
